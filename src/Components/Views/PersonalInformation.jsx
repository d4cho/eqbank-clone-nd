                    ...
                    <form action='' onSubmit={handleSubmit}>
                        <div className='text-field-container'>
                            ...
                            <TextField
                                ...
                                error={error}
                                onBlur={() => {
                                    if (!personalValues.streetAddress) {
                                        setError(true);
                                    } else {
                                        setError(false);
                                    }
                            ...
                            />
                            {submitted && error && !personalValues.streetAddress ? (
                                <div
                                    style={{
                                        display: 'flex',
                                        alignItems: 'center',
                            ...
                            {submitted && !regexPostalCode.test(personalValues.streetAddress) ? (
                                <div
                                    style={{
                                        display: 'flex',
                                        alignItems: 'center',
                        ...
                        <div style={{ display: 'flex', flexDirection: 'row', gap: '10px' }}>
                            ...
                            >
                                ...
                                {submitted && !regexPostalCode.test(personalValues.postalCode) ? (
                                    <div
                                        style={{
                                            display: 'flex',
                                            alignItems: 'center',
